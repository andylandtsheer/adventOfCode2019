...
public class DayOne {
    ...
    public static void main(String[] args) {
        ...
        int totalAmountOfFuelfor1=0;
        int totalAmountOfFuelfor2=0;
        ...
        for (int weightOfModule : listOfModuleWeight) {
            totalAmountOfFuelfor1 = dayOne.calculateFuelConsumption(weightOfModule) + totalAmountOfFuelfor1;
            totalAmountOfFuelfor2 = dayOne.calculateAmountOfFuel(weightOfModule) + totalAmountOfFuelfor2;
        }

        System.out.println(totalAmountOfFuelfor1);
        System.out.println(totalAmountOfFuelfor2);
    }

    public int calculateFuelConsumption(int weightOfModule) {
        return (weightOfModule / 3) - 2;
    }

    public int calculateAmountOfFuel(int weightOfModule) {
        int weightToReturn = 0;
        while (weightOfModule>=9){
            weightToReturn = (weightOfModule / 3 - 2) + weightToReturn;
            weightOfModule = (weightOfModule / 3 - 2);
        }
