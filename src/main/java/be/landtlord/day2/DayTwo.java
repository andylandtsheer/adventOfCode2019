...
public class DayTwo {
    public static void main(String[] args) {
        ...
        int[] result = dayTwo.processIntcode(intCode.clone());
        System.out.println(result[0]);

        int resultNumber2 = dayTwo.processIntcodeTillSolution(intCode);
        System.out.println(resultNumber2);
    }

    public int processIntcodeTillSolution(int[] intCode) {
